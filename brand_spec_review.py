...
#   всего разорвано 907 пар
# Из первых 10 проверенных разрывов 6 оказались полезными (сцепка была ложной),
# 1 ошибочным. Проверка остальных не закончена — до неё режим не включаем.

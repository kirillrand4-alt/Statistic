...
# Из 20 проверенных агентами разрывов 8 полезных (сцепка была ложной), 3 ошибочных,
# остальные к этому моменту уже починены нормализацией. Проверка не закончена —
# до неё режим не включаем. Включение: VARIANT_STRICT=1.

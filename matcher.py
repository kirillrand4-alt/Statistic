...
BRAND_ALIASES = {
    ...
    # ресиверные бренды — понадобились 19.08, когда в матчер завели ресиверы: у нас 213
    # карточек DNT (пишем и латиницей, и кириллицей) и 70 «ЕвразКомпрессор», у конкурентов
    # DNT есть на 105 карточках. Без алиаса бренд не определялся вовсе, и вся эта часть
    # каталога висела без пары в принципе.
    "dnt":"dnt","днт":"dnt","евразкомпрессор":"evraz","евраз":"evraz",
}
